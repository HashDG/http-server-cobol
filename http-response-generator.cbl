...
77 OK PIC X(16) VALUE "HTTP/1.1 200 OK%".
77 NOT-FOUND PIC X(23) VALUE "HTTP/1.1 404 NOT FOUND%".
...
01 HEADER-STATUS-CODE PIC X(30).
01 FILLER PIC X(2) VALUE X"0A0D".
01 HEADER-CONTENT-LENGTH PIC X(20) VALUE "Content-Length:".
01 FILLER PIC X(2) VALUE X"0A0D".
01 HEADER-CONTENT-TYPE PIC X(64) VALUE "Content-Type:".
...
01 RESPONSE-LENGTH BINARY-INT UNSIGNED.

PROCEDURE DIVISION USING REQUEST, RESPONSE, RESPONSE-LENGTH.
   MOVE 1 TO LOCAL-RESPONSE-LENGTH.
   ...
   STRING HEADER-STATUS-CODE DELIMITED BY '%'
       X"0D0A" DELIMITED BY SIZE
       HEADER-CONTENT-LENGTH DELIMITED BY SPACE
       X"0D0A" DELIMITED BY SIZE
       HEADER-CONTENT-TYPE DELIMITED BY SPACE
   ...
   SUBTRACT 1 FROM LOCAL-RESPONSE-LENGTH.
