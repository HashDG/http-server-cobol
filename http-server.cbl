...
*> RESOURCES
01 RESOURCES-FOLDER PIC X(256) VALUE "http_ressources".
01 RESOURCES-FOLDER-LENGTH PIC 9(3) VALUE 15.
01 RESOURCES.
...
INIT-HTTP.
   ...
   CALL "HTTP-RESOURCES-SCRAPER" USING
      BY CONTENT RESOURCES-FOLDER
      BY CONTENT RESOURCES-FOLDER-LENGTH
      BY CONTENT ZERO
...
RUN-HTTP.
   ...
   PERFORM UNTIL END-SERVER
      ...
      CALL "HTTP-RESPONSE-GENERATOR" USING
         BY CONTENT REQUEST
         BY REFERENCE RESPONSE
         BY REFERENCE RESPONSE-LENGTH
      END-CALL

      DISPLAY "RESPONSE: >" RESPONSE(1:RESPONSE-LENGTH) "<"

      PERFORM WRITE-SOCKET
...
WRITE-SOCKET.
    DISPLAY "BEGIN WRITE".
    DISPLAY "LENGTH: " LENGTH(RESPONSE).
